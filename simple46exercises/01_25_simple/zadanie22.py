...
TODO: wrote encode(message, rot) and decode(message, rot) where message is
a string to encode/decode and rot is the cipher key.

cache once calculated keys in memory to avoid recreating cipher key each time
...
if __name__ == '__main__':
    print(encode("Pnrfne pvcure? V zhpu cersre Pnrfne fnynq!"))
    print(encode("Caesar cipher? I much prefer Caesar salad!"))
